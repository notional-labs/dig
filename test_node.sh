...
digd keys add $KEY --keyring-backend $KEYRING --algo $KEYALGO --home $HOME
...
digd start --pruning=nothing  --minimum-gas-prices=0.0001stake --rpc.laddr tcp://127.0.0.1:26650 --home $HOME
