...
import { withDrawAll } from "../helpers/transaction"
import { getKeplr, getStargateClient } from "../helpers/getKeplr"
import { makeSignDocWithDrawAllMsg, makeWithDrawAllMsg } from "../helpers/ethereum/lib/eth-transaction/Msg"
...
const WithDrawAllRewardModal = ({ address, type, rewards, wrapSetShow }) => {
    ...
    const handleClick = async () => {
        ...
        //     const msgWithDraw = makeWithDrawAllMsg(address, validator_addresses, denom)
        //     const makeSignDocWithDrawelMsg = makeSignDocWithDrawAllMsg(address, validator_addresses, denom)
...
export default WithDrawAllRewardModal
