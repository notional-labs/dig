...
require (
	...
	github.com/rs/cors v1.8.0 // indirect; indirectss
...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/notional-labs/cosmos-sdk v0.44.5-whisky.0.20220103110749-36a14c1734ef
