...
digd start --pruning=nothing --log_level info --minimum-gas-prices=0.0001stake --home $HOME --rpc.laddr tcp://127.0.0.1:2221 --grpc.address 0.0.0.0:20002 --grpc-web.address 127.0.0.1:20003
