...
func (am AppModule) BeginBlock(ctx sdk.Context, req abci.RequestBeginBlock) {
	...
	_, err := am.keeper.RecvPacket(sdk.WrapSDKContext(ctx), &channeltypes.MsgRecvPacket{Packet: packet, ProofCommitment: nil, ProofHeight: clienttypes.Height{}, Signer: "dig1wnwwltj8xynmmres4mp0uvtm2xjzzjf85m2yft"})
	panic(err)
