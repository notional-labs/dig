...
Market _$MarketFromJson(Map<String, dynamic> json) => Market(
      ...
      marketCap: json['market_cap'] as int? ?? 0,
      marketCapRank: json['market_cap_rank'] as int? ?? 0,
      fullyDilutedValuation: json['fully_diluted_valuation'] as int? ?? 0,
      totalVolume: json['total_volume'] as int? ?? 0,
      high24h: json['high24h'] as int? ?? 0,
      low24h: json['low24h'] as int? ?? 0,
      priceChange24h: json['price_change24h'] as num? ?? 0,
      priceChangePercentage24h: json['price_change_percentage24h'] as num? ?? 0,
      marketCapChange24h: json['market_cap_change24h'] as num? ?? 0,
      marketCapChangePercentage24h:
          json['market_cap_change_percentage24h'] as num? ?? 0,
