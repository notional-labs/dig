...
class StakeAuthorization_Validators extends $pb.GeneratedMessage {
  ...
  factory StakeAuthorization_Validators() => create();
  ...
  'Will be removed in next major version')
  StakeAuthorization_Validators copyWith(void Function(StakeAuthorization_Validators) updates) => super.copyWith((message) => updates(message as StakeAuthorization_Validators)); // ignore: deprecated_member_use
...
class StakeAuthorization extends $pb.GeneratedMessage {
  ...
  factory StakeAuthorization() => create();
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StakeAuthorization copyWith(void Function(StakeAuthorization) updates) => super.copyWith((message) => updates(message as StakeAuthorization)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
